      ...
      db.query('SELECT nombre_completo, correo, usuario, rol, estado, fecha_creacion FROM usuarios WHERE empresa_id = ?', [id], (err3, usuarios) => {
        ...
        `, [id], (err4, historial) => {
          ...
          if (equipos.length) {
            const camposEquipos = [
              { label: 'ID',                   value: 'id' },
              { label: 'Número inventario',    value: 'numero_inventario' },
              { label: 'Etiqueta física',      value: 'etiqueta_fisica' },
              { label: 'Nombre',               value: 'nombre' },
              { label: 'Tipo',                 value: 'tipo' },
              { label: 'Sistema operativo',    value: 'sistema_operativo' },
              { label: 'Procesador',           value: 'procesador' },
              { label: 'Host',                 value: 'nombre_host' },
              { label: 'Marca',                value: 'marca' },
              { label: 'Modelo',               value: 'modelo' },
              { label: 'Núm. Serie',           value: 'numero_serie' },
              { label: 'MAC',                  value: 'direccion_mac' },
              { label: 'IP',                   value: 'direccion_ip' },
              { label: 'Tipo de IP',          value: 'tipo_ip' },
              { label: 'Conectado a red',      value: 'conectado_red' },
              { label: 'Área',                 value: 'area' },
              { label: 'Ubicación física',     value: 'ubicacion_fisica' },
              { label: 'Encargado',            value: 'encargado_equipo' },
              { label: 'Usuario responsable',   value: 'usuario_responsable' },
              { label: 'Correo jefe de área',  value: 'correo_jefe_area' },
              { label: 'Fecha adquisición',    value: 'fecha_adquisicion' },
              { label: 'Fecha baja/renovación',value: 'fecha_baja_renovacion' },
              { label: 'Proveedor',            value: 'proveedor' },
              { label: 'Factura / Ref.',       value: 'referencia_factura' },
              { label: 'Garantía / soporte',   value: 'garantia' },
              { label: 'Costo adquisición',    value: 'costo_adquisicion' },
